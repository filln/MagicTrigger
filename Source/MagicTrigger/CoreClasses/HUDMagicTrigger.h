...
public:
	...
	/**
	 *Просмотр, выбор сохраненных игр. Используется в виджете, когда ЛКМ по полю сохраненной игры. Если поле выбирается, то вводится bCheck == true, если
	 поле автоматически перестает быть выбранным, то вводится bCheck == false.
	 */
	UFUNCTION(BlueprintCallable, Category = "HUDMagicTrigger")

...
ASevenfoldShere::ASevenfoldShere()
{
...
void ASevenfoldShere::BeginPlay()
{
	Super::BeginPlay();
...
void ASevenfoldShere::IncreaseScaleAndEmissiveAfterSpawn()
{
...
void ASevenfoldShere::DecreaseScaleAndEmissiveAfterSpawn()
{
	FTimerDelegate TmpDelegate;
	TmpDelegate.BindLambda
	(

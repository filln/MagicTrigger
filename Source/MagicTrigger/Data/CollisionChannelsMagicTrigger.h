 ...
 */
 ...
 /**
 * MagicTrigger\Config\DefaultEngine.ini
  *  +DefaultChannelResponses=(Channel=ECC_GameTraceChannel1,DefaultResponse=ECR_Overlap,bTraceType=False,bStaticObject=False,Name="ThrowableObject")
	 ...
	 +DefaultChannelResponses=(Channel=ECC_GameTraceChannel7,DefaultResponse=ECR_Block,bTraceType=False,bStaticObject=False,Name="RoundWave")
  */
...
//Collision channel
#define ECC_RoundWave					ECC_GameTraceChannel7
